...
if select_mode == "Default":
    ...
    sliders_labels = ['0 to 1k Hz', '1k to 2k Hz', '2k to 3k Hz','3k to 4k Hz','4k to 5k Hz', '5k to 6k Hz','6k to 7k Hz', '7k to 8k Hz',
    '8k to 9k Hz','9k to 10k Hz']
    ...
    signal_y_axis     = electrocardiogram()                                 # Calling the arrhythmia database
